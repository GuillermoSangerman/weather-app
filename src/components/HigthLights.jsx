    ...
    <>
        <div className='grid grid-cols-1 gap-5 px-10 md:px-5 md:grid-cols-2 xl:px-35 xl:gap-8'>
              <div className='bg-[#1E213A] mt-5 pt-3 flex flex-col items-center'>
                ...
                <p className='text-7xl font-semibold my-6 md:text-5xl xl:text-7xl'>1.95<span className='align-top text-5xl font-normal'>ms</span></p>
              ...
              <div className='bg-[#1E213A] pt-3 pb-4 flex flex-col items-center md:mt-5'>
                ...
                <p className='text-7xl font-semibold my-6 md:text-5xl xl:text-7xl'>81
              ...
              <div className='bg-[#1E213A] pt-3 pb-4 flex flex-col items-center'>
                ...
                <span className='text-7xl font-bold my-6 md:text-5xl xl:text-7xl'>10.00 
              ...
              <div className='bg-[#1E213A] pt-3 pb-4 flex flex-col items-center'>
                ...
                <span className='text-7xl font-bold my-6 md:text-5xl xl:text-7xl'>1021
